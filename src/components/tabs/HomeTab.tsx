  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Spline 3D Scene Background - Enlarged */}
        <main className="absolute inset-0 w-full h-full scale-[1.15]">
          <Spline
            scene="https://prod.spline.design/4UafzF3exFxPPgi6/scene.splinecode" 
          />
        </main>
        
        {/* Vignette - Bottom Left Corner */}
        <div 
          className="absolute bottom-0 left-0 w-1/2 h-1/2 pointer-events-none"
          style={{
            background: 'radial-gradient(ellipse at bottom left, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0.8) 20%, rgba(0, 0, 0, 0.4) 40%, transparent 70%)'
          }}
        />
        
        {/* Vignette - Bottom Right Corner */}
        <div 
          className="absolute bottom-0 right-0 w-1/2 h-1/2 pointer-events-none"
          style={{
            background: 'radial-gradient(ellipse at bottom right, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0.8) 20%, rgba(0, 0, 0, 0.4) 40%, transparent 70%)'
          }}
        />
        
        {/* Text Overlay */}
        <div className="relative z-10 max-w-6xl mx-auto text-center px-6 sm:px-8 lg:px-12 pointer-events-none mt-48">
          {/* First line with animated text - left-aligned expansion with fixed container */}
          <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-200 mb-4 max-w-4xl mx-auto drop-shadow-lg font-bold leading-tight flex flex-wrap items-center justify-center gap-x-2">
            <span>We build systems that build</span>
            <span className="inline-flex justify-start items-center overflow-hidden" style={{ minWidth: '200px' }}>
              <ContainerTextFlip words={["Companies", "Progress", "Future", "Civilization"]} className="text-lg sm:text-xl md:text-2xl lg:text-3xl" />
            </span>
          </div>
          
          {/* Second paragraph - static description with bold Regalitica */}
          <p className="text-sm sm:text-base md:text-lg text-gray-300 max-w-3xl mx-auto drop-shadow-lg leading-relaxed mb-8">
              ...
              <div className="notification-box mb-3">
                <div className="box-inner">
                  <div className="relative flex flex-col">
                    ...
                    <h3 className="notititle mb-5">Problem Statement</h3>
              ...
              <div className="notification-box mb-3">
                <div className="box-inner">
                  <div className="relative flex flex-col">
                    ...
                    <h3 className="notititle mb-5">Value Proposition</h3>
                    <div className="vanish-crossfade-container">
                      <p 
