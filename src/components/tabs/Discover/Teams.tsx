  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* Portrait column — full-bleed image */}
        <div style={{
          ...
          {founder.src ? (
            ...
            <div style={{
              ...
              backgroundImage: 'radial-gradient(circle, rgba(227,27,84,0.15) 1px, transparent 1px)',
        ...
        <div className="fc-modal-info" style={{
          ...
          <p style={{
            ...
            color: '#E31B54', fontWeight: 700, textTransform: 'uppercase' as const,
            letterSpacing: '0.14em', margin: '10px 0 0',
          }}>{founder.title}</p>

          <span className="fc-modal-role-tag" style={{
          ...
          <div className="fc-modal-divider" style={{
          ...
          <div style={{ marginBottom: '24px' }}>
            <span className="fc-modal-about-label" style={{
              display: 'block', fontFamily: 'ui-monospace, Menlo, monospace',
              fontSize: '9px', textTransform: 'uppercase' as const, letterSpacing: '0.22em',
              color: 'rgba(255,255,255,0.25)', marginBottom: '10px',
            }}>About</span>
            <p className="fc-modal-bio" style={{ fontSize: '14px', lineHeight: 1.85, color: 'rgba(255,255,255,0.55)', margin: 0 }}>
              {founder.bio}
            </p>
          </div>

          {/* Stats */}
          <div className="fc-modal-stats" style={{
            ...
            {modalStats.map((s, i) => (
              <React.Fragment key={s.lab}>
                ...
                <div style={{
                  flex: 1, display: 'flex', flexDirection: 'column',
                  alignItems: 'center', justifyContent: 'center', padding: '16px 8px', gap: '6px',
                }}>
                  <span className="fc-modal-stat-val" style={{
                    fontFamily: 'ui-monospace, Menlo, monospace', fontSize: '16px',
                    fontWeight: 700, color: s.accent ? '#E31B54' : '#f1f5f9', letterSpacing: '-0.02em',
                  }}>{s.val}</span>
                  <span className="fc-modal-stat-lab" style={{
                    fontFamily: 'ui-monospace, Menlo, monospace', fontSize: '9px',
                    textTransform: 'uppercase' as const, letterSpacing: '0.16em',
                    color: 'rgba(255,255,255,0.25)', textAlign: 'center' as const,
                  }}>{s.lab}</span>
                </div>
              </React.Fragment>
            ))}
          ...
          {/* Footer — nav tab style buttons */}
          <div className="fc-modal-footer" style={{
            ...
            <div className="teams-tab-border">
              <div className="teams-tab-item">
                <a
                  ...
                  onClick={e => e.stopPropagation()}
                  className="teams-tab-btn modal-btn"
            ...
            <div className="teams-tab-border" style={{ marginLeft: 'auto' }}>
              <div className="teams-tab-item">
                <button className="teams-tab-btn modal-btn" onClick={onClose}>
                  Close Profile
                </button>
              </div>
            </div>
...
/* ─────────────────────────────────────────
   FOUNDER CARD
───────────────────────────────────────── */
const FounderCard = memo(({ founder, index, onExpand }: {
  founder: Founder;
  index: number;
  onExpand: (f: Founder) => void;
}) => {
  ...
  return (
    <div
      ...
      onClick={() => onExpand(founder)}
      role="button"
      tabIndex={0}
      onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') onExpand(founder); }}
    >
          ...
          <div className="teams-tab-border" onClick={e => e.stopPropagation()}>
            <div className="teams-tab-item">
              <a
                href={founder.linkedin}
                aria-label="LinkedIn"
                className="teams-tab-btn fc-btn"
                style={{ textDecoration: 'none' }}
              >
                <svg viewBox="0 0 24 24" fill="currentColor" width="15" height="15"><path d={LINKEDIN_PATH} /></svg>
              </a>
  ...
  return (
    <>
      <style>{`
        ...
        :root.light .teams-tab-border:hover .teams-tab-item {
        ...
        .teams-eyebrow{
          ...
          text-transform:uppercase;letter-spacing:.22em;font-weight:700;color:#E31B54;margin-bottom:1.25rem;
        }
        .teams-eyebrow-dot{
        ...
        @media(min-width:640px){.teams-sub{font-size:1rem;}}
        .teams-stats-box{
          border:1px dashed var(--border-dashed);display:grid;
          grid-template-columns:repeat(3,1fr);min-width:480px;position:relative;align-self:center;
        }
        @media(max-width:767px){.teams-stats-box{min-width:0;width:100%;}}
        .teams-stats-box::before,.teams-stats-box::after{
          content:'';position:absolute;left:0;right:0;height:2px;background:#E31B54;box-shadow:0 0 10px rgba(227,27,84,.5);
        }
        ...
        /* ── Founders section — removed dashed border, tightened spacing ── */
        ...
        .founders-label{
          font-size:.62rem;font-family:ui-monospace,Menlo,monospace;text-transform:uppercase;
          letter-spacing:.22em;font-weight:700;color:rgba(255,255,255,.3);white-space:nowrap;
        }
        ...
        .fc-outer{
          ...
          padding:1px;backdrop-filter:blur(4px);
        ...
        .fc-outer:hover .fc-portrait-img{
          filter: grayscale(0%) brightness(1);
        }
        .fc-dot-grid{
          position:absolute;inset:0;
          background-image:radial-gradient(circle,rgba(227,27,84,.12) 1px,transparent 1px);
          background-size:22px 22px;
        }
        .fc-bottom-fade{
          position:absolute;bottom:0;left:0;right:0;height:50%;
          background:linear-gradient(to top,var(--gradient-card,#0f0f1a) 10%,transparent);
        ...
        .fc-id{
          ...
          border:1px solid rgba(255,255,255,.12);padding:4px 9px;border-radius:4px;z-index:2;
        }
        .fc-info{
          padding:1.75rem 1.5rem 1.25rem;display:flex;flex-direction:column;gap:.65rem;
          border-top:1px solid rgba(255,255,255,.05);background:transparent;
        }
        ...
        .fc-title{
          font-size:.75rem;color:#E31B54;font-weight:700;
          font-family:ui-monospace,Menlo,monospace;text-transform:uppercase;
          letter-spacing:.12em;margin:0;transition:transform .3s;
        }
        ...
        .fc-footer{
          ...
          border-top:1px solid rgba(255,255,255,.04);transition:border-color .3s;margin-top:auto;
        }
        ...
        /* Light mode — modal */
        :root.light .fc-modal-panel{
          background:#f8fafc !important;
          border:1px solid rgba(0,0,0,.12) !important;
          box-shadow:0 24px 60px rgba(0,0,0,.14), 0 0 0 1px rgba(0,0,0,.06) !important;
        }
        ...
        :root.light .fc-modal-name{
          background:linear-gradient(135deg,#0f172a 0%,rgba(15,23,42,.65) 100%) !important;
